...
New features were added and now the user is able to mark the tasks priority as low, medium and high and also mark the tasks as in progress and complete.
